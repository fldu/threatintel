...
type NistData struct {
	CVEid              string  `json:"cve_id"`
	Description        string  `json:"description"`
	ReferenceUrl       string  `json:"ref_url"`
	ReferenceSource    string  `json:"ref_source"`
	AttackVector       string  `json:"attack_vector"`
	AttackComplexity   string  `json:"attack_complex"`
